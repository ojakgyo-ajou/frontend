  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          'group/drawer-content bg-background fixed z-50 flex h-auto flex-col px-2',
...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="drawer-header" className={cn('flex flex-col gap-1.5 p-4 mt-2', className)} {...props} />;
}
...
function DrawerTitle({ className, ...props }: React.ComponentProps<typeof DrawerPrimitive.Title>) {
  return (
    <DrawerPrimitive.Title
      ...
      className={cn('scroll-m-20 text-2xl font-semibold tracking-tight mb-2', className)}
      {...props}
    />
  );
}
